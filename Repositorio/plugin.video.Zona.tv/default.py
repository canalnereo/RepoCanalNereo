...
def Repo():
    if os.path.exists(os.path.join(xbmc.translatePath("special://home/addons/").decode("utf-8"), 'plugin.video.Zona.tv')):
        return
        
    url = "https://github.com/Torokodi/Toro/tree/master/Repositorio"
...
if mode==None:	
    ...
    import xbmc
    xbmc.executebuiltin("XBMC.Notification(Zona.tv, Version: 1.3 ,5000,"+icon+")")
